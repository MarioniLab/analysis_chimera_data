...
<!-- Comparing celltypes called between 2020 paper and mapping to new atlas -->

<!-- ```{r} -->
<!-- chimeraT_2020$celltype_big_atlas <- chimeraT$celltype.mapped[match(chimeraT_2020$cell,chimeraT$cell)] -->
<!-- table(chimeraT_2020$celltype_big_atlas[chimeraT_2020$celltype.mapped=="NMP"]) -->
<!-- ``` -->
<!-- How does this differ between tomato positive and tomato negative? -->

<!-- ```{r} -->
<!-- table(chimeraT_2020$celltype_big_atlas[chimeraT_2020$celltype.mapped=="NMP" & chimeraT_2020$tomato]) -->
<!-- ``` -->
<!-- ```{r} -->
<!-- table(chimeraT_2020$celltype_big_atlas[chimeraT_2020$celltype.mapped=="NMP" & !(chimeraT_2020$tomato)]) -->
<!-- ``` -->
...
<!-- ```{} -->
<!-- chimeraWT_2020$celltype_big_atlas <- chimeraWT$celltype.mapped[match(chimeraWT_2020$cell,chimeraWT$cell)] -->
<!-- table(chimeraWT_2020$celltype_big_atlas[chimeraWT_2020$celltype.mapped=="NMP"]) -->
<!-- ``` -->
<!-- How is the mapping different in terms of stages? -->

<!-- ```{r} -->
<!-- chimeraT_2020_tomato <- chimeraT_2020[,chimeraT_2020$tomato] -->
<!-- chimeraT_2020_tomato$stage_mapped_extended <- chimeraT$stage.mapped[match(chimeraT_2020_tomato$cell,chimeraT$cell)] -->
<!-- levels <- sort(unique(c(chimeraT_2020_tomato$stage_mapped_extended,chimeraT_2020_tomato$stage.mapped))) -->
<!-- prop_stages <- 100*c(as.vector(table(factor(chimeraT_2020_tomato$stage_mapped_extended, levels=levels)))/ -->
<!--                                       length(chimeraT_2020_tomato$stage_mapped_extended), -->
<!--                                     as.vector(table(factor(chimeraT_2020_tomato$stage.mapped, levels=levels)))/ -->
<!--                                       length(chimeraT_2020_tomato$stage.mapped)) -->
<!-- stages_Target_8.5 <- c(names(table(factor(chimeraT_2020_tomato$stage_mapped_extended, levels=levels))), -->
<!--                          names(table(factor(chimeraT_2020_tomato$stage.mapped, levels=levels)))) -->

<!-- dataset <- c(rep("extended_mapping",length(stages_Target_8.5)*0.5), -->
<!--                rep("2020_mapping",length(stages_Target_8.5)*0.5)) -->
<!-- p1 = ggplot(mapping = aes(x = stages_Target_8.5,y=prop_stages, fill = dataset)) + -->
<!--   geom_bar(stat="identity",position="dodge") + -->
<!--   scale_fill_manual(values=c( "2020_mapping" = "darkgreen","extended_mapping" = "brown"), name = "")+ -->
<!--   labs(x = "", y = "% of cells") + -->
...
<!--                    drop = FALSE) + ggtitle("T chimeras, tomato positive cells") -->
<!-- print(p1) -->
<!-- ``` -->
...
<!-- ## Per-celltype differential abundance testing -->
...
<!-- ```{r,eval=FALSE} -->
<!-- odds_ratio -->
<!-- write.table(odds_ratio,file="odds_ratio_T_rev.csv",col.names=TRUE,row.names=FALSE,sep=",",quote=FALSE) -->
